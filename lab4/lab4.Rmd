...
ggplot(
  data = penguins,
  mapping = aes(x=species,y=body_mass_g))+geom_boxplot()
...
ggplot(
  data = penguins,
  mapping = aes(x=body_mass_g,y=flipper_length_mm))+
  geom_point(na.rm=T,mapping=aes(color=species))+
  geom_smooth(method=lm, se=T)
```
...
ggplot(
  data = penguins,
  mapping = aes(x=body_mass_g,y=flipper_length_mm))+
  geom_point(na.rm=T,mapping=aes(color=species, shape = island))+
  geom_smooth(method=lm, se=T)
```
...
```{r}
ggplot(
  data = penguins, mapping = aes(x = species))+
  geom_bar()
```
...
ggplot(
  data = penguins, mapping = aes(x = species))+
  geom_bar(mapping=aes(colour = species))
```
...
```{r}
ggplot(
  data = penguins, mapping = aes(x = island))+
